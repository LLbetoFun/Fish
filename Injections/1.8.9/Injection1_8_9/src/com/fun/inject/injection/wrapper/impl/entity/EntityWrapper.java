...
public class EntityWrapper extends Wrapper {
    ...
    public float getYaw() {
        ...
        return ((Entity)obj).rotationYaw;
    }

    public float getPitch() {
        // FD: pk/z net/minecraft/entity/Entity/field_70125_A
        return ((Entity)obj).rotationPitch;

    }
    public void setYaw(float yaw) {
        // FD: pk/y net/minecraft/entity/Entity/field_70177_z
        ((Entity)obj).rotationYaw = yaw;
    }

    public void setPitch(float pitch) {
        // FD: pk/z net/minecraft/entity/Entity/field_70125_A
        ((Entity)obj).rotationPitch=pitch;        //return value == null ? 0.0f : (Float) value;
    }
