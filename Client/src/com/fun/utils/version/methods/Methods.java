...
public enum Methods {
    ...
    public String getName(){
        VMethod V1=map.get(In9ectManager.minecraftType).get(In9ectManager.minecraftVersion);
        if(V1!=null)return V1.obf_name;
        VMethod V2=map.get(MinecraftType.VANILLA).get(In9ectManager.minecraftVersion);
